...
const Register = () => {
  ...
  return (
    <RegisterWrapper>
      ...
      <RegisterBack>
      <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.yubico.com%2Fproducts%2Fcomputer-login-tools%2F&psig=AOvVaw1jKDQ3EsFR7I0-Iko8DhVV&ust=1676314748964000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCPD9yuTVkP0CFQAAAAAdAAAAABAD" alt="login" />
        <h2>Ponraj Thuvarakan</h2>
        <p>
          Hello I'm Ponraj thuvarakan & currently an undergraduate at Uva Wellassa University of Sri Lanka pursuing my B.Sc. (Hons) in Industrial Information Technology. FrontEnd Developer
        </p>
      </RegisterBack>
    </RegisterWrapper>
  );
